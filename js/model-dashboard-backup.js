...
function updateHeaderMenu(userData) {
    ...
    // Добавляем ссылку на панель управления только для моделей
    const modelDashboardLink = userData.userType === 'model' ? 
        '<a href="model-dashboard.html" style="display: block; padding: 10px 15px; color: #4a5568; text-decoration: none; transition: background 0.3s ease;" onmouseover="this.style.background=\'#f7fafc\'; this.style.color=\'#667eea\'" onmouseout="this.style.background=\'\'; this.style.color=\'#4a5568\'">📊 Панель управления</a>' : 
        '';
